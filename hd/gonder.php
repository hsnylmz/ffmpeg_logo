...
$batfile = 'C:\\xampp\\htdocs\\Logo\\hd\\logobindirHD.bat';
...
$myfile = fopen("$batfile", "w") or die("Unable to open file!");
  ...
  $txt = "$ffmpegfile -i \"E:\\Logo\\logosuz\\$value\" -i $logofile -filter_complex \"[0:v][1:v] overlay=40:40\"  \"$bitendir\\$value"."_logolu.mp4\" ";
...
<tr><td><a href="logobindirHD.bat">indir</td></tr>
</table>

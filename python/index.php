...
<?php
$videodir = 'E:\Logo\logolu\*.{mxf,mp4,mov,mpg,MXF,MP4,MOV,MPG}';
...
<div class="sablon">
	...
	<table>
			<tr>
				<td><input type="submit" value="Python Dosyası Oluştur."></td>
			</tr>
			<tr>
			...
			<tr><td><input type="submit" value="Python Dosyası Oluştur."></td></tr>
	</table>

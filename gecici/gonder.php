...
$bitendir = 'D:\\Materyal\\logolu';
$videodir = 'D:\Materyal\*.{mxf,mp4,mov,mpg,MXF}';
//$videodir = 'L:\*.{mxf,mp4,mov,mpg,MXF}';
$batfile = 'D:\\Materyal\\logobindirHD.bat';
...
$myfile = fopen("$batfile", "w") or die("Unable to open file!");
  ...
  $txt = "$ffmpegfile -i \"D:\\Materyal\\$value\" -i $logofile -filter_complex \"[0:v][1:v] overlay=60:50\"  \"$bitendir\\$value"."_logolu.mp4\" \n";

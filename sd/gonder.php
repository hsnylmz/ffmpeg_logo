...
$batfile = 'C:\\xampp\\htdocs\\Logo\\sd\\logobindirSD.bat';
$logofile = 'E:\\Logo\\belgesel_sd.png';
...
$myfile = fopen("$batfile", "w") or die("Unable to open file!");
  ...
  $txt = "$ffmpegfile -i \"E:\\Logo\\logosuz\\$value\" -i $logofile -filter_complex \"[0:v][1:v] overlay=20:50\"  \"$bitendir\\$value"."_logolu.mp4\" \n";
...
<tr><td><a href="logobindirSD.bat">indir</td></tr>
</table>
